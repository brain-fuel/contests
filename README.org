...
1. Prompt
2. List of judges
3. Submission time window
4. Link to contest GitHub repository
5. Link to submission form
** Judges
The judge(s) for each contest will be announced in the posting for each contest.
** Rules
*** Submissions
...
2. In order to be considered, submissions must arrive as a pull request to the appropriate GitHub repository within the time window specified in the contest [[#posting][posting]]. Early submissions may be given feedback at the discretion of the judge(s)
